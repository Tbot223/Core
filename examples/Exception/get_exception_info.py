...
if __name__ == "__main__":
    ...
    try:
        ...
        exc_info = tracker.get_exception_info(e, params=((), {}), mask_tuple=(False, False, False, False))
    ...
    try:
        ...
        exc_info_masked = tracker.get_exception_info(e, params=((), {}), mask_tuple=(True, True, True, True))
