...
if __name__ == "__main__":
    ...
    try:
        ...
        exc_info = tracker.get_exception_return(error=e, user_input="1 / 0", params=((), {}), masking=False)
    ...
    try:
        ...
        exc_info_masked = tracker.get_exception_return(error=e, user_input="lst[5]", params=((), {}), masking=True)
